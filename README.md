...
| c | Output tok/s | Power (W) | $/M out tok @ $0.12/kWh |
|---|-------------|-----------|-------------------------|
| 1 | 11.41 | 33 (telemetry avg) | 0.096 |
| 8 | 48.98 | 33 | 0.023 |

Full ladder + **Power & token cost** section in the HTML report. Artifact: `benchmarks/energy_cost_metrics.json` (regenerated by `build_report.py`).
